...
const Icon: React.FC<SvgProps> = (props) => (
  <Svg viewBox="0 0 80 80" {...props}>
    ...
    <path d="M61.524 14.582h14.534v4.536H61.524v-4.536zM3.941 14.582h14.535v4.536H3.94v-4.536z" fill="#3DA4AB" />
    <path d="M18.477 8.478v55.418h6.715V40h29.616v23.896h6.716V8.478H18.477z" fill="#F6CD61" />
    <path
